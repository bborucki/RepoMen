...
typedef enum  {
  ...
  PROTO_MT_EVENT_BASE_FLAG,
  PROTO_MT_EVENT_BASE_PICKUP,
  PROTO_MT_EVENT_BASE_DROP,
  PROTO_MT_EVENT_BASE_WIN,
  PROTO_MT_EVENT_BASE_PLAYER_QUIT,
  PROTO_MT_EVENT_BASE_PLAYER_JOIN,
  PROTO_MT_EVENT_BASE_SERVER_QUIT,
